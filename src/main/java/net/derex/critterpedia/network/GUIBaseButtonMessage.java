...
public class GUIBaseButtonMessage {
	private final int buttonID, x, y, z;

	public GUIBaseButtonMessage(FriendlyByteBuf buffer) {
	...
	public GUIBaseButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(GUIBaseButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GUIBaseButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = GUIBaseMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CritterpediaMod.addNetworkMessage(GUIBaseButtonMessage.class, GUIBaseButtonMessage::buffer, GUIBaseButtonMessage::new, GUIBaseButtonMessage::handler);
	}
}
