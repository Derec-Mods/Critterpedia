...
public class AmphGUIButtonMessage {
	private final int buttonID, x, y, z;

	public AmphGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public AmphGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(AmphGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(AmphGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = AmphGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CritterpediaMod.addNetworkMessage(AmphGUIButtonMessage.class, AmphGUIButtonMessage::buffer, AmphGUIButtonMessage::new, AmphGUIButtonMessage::handler);
	}
}
