...
public class SeaGUIButtonMessage {
	private final int buttonID, x, y, z;

	public SeaGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public SeaGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(SeaGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(SeaGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = SeaGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CritterpediaMod.addNetworkMessage(SeaGUIButtonMessage.class, SeaGUIButtonMessage::buffer, SeaGUIButtonMessage::new, SeaGUIButtonMessage::handler);
	}
}
