...
public class BugGUIButtonMessage {
	private final int buttonID, x, y, z;

	public BugGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public BugGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(BugGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(BugGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = BugGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		CritterpediaMod.addNetworkMessage(BugGUIButtonMessage.class, BugGUIButtonMessage::buffer, BugGUIButtonMessage::new, BugGUIButtonMessage::handler);
	}
}
