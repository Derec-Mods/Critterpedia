package net.derex.critterpedia.block.entity;
...
public class GalapgosTortoiseShellBlockTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public GalapgosTortoiseShellBlockTileEntity(BlockPos pos, BlockState state) {
		super(CritterpediaModBlockEntities.GALAPGOS_TORTOISE_SHELL_BLOCK.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<GalapgosTortoiseShellBlockTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<GalapgosTortoiseShellBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("galapgos_tortoise_shell_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Galapgos Tortoise Shell Block");
	}
