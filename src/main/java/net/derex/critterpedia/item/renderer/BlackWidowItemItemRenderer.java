package net.derex.critterpedia.item.renderer;
...
import net.derex.critterpedia.item.model.BlackWidowItemItemModel;
import net.derex.critterpedia.item.BlackWidowItemItem;
import net.derex.critterpedia.interfaces.RendersPlayerArms;
...
public class BlackWidowItemItemRenderer extends GeoItemRenderer<BlackWidowItemItem> implements RendersPlayerArms {
	public BlackWidowItemItemRenderer() {
		super(new BlackWidowItemItemModel());
	}

	@Override
	public RenderType getRenderType(BlackWidowItemItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof BlackWidowItemItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new BlackWidowItemItemRenderer();
	...
	protected BlackWidowItemItem animatable;
	...
	@Override
	public void render(GeoModel model, BlackWidowItemItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(BlackWidowItemItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(BlackWidowItemItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(BlackWidowItemItem animatable) {
