...
import net.derex.critterpedia.item.renderer.BlackWidowItemItemRenderer;
...
public class BlackWidowItemItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public BlackWidowItemItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new BlackWidowItemItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, BlackWidowItemItemRenderer renderer) {
	...
	public void setupAnimationState(BlackWidowItemItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
