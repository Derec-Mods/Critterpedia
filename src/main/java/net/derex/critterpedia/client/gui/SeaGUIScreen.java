...
import net.derex.critterpedia.network.SeaGUIButtonMessage;
...
public class SeaGUIScreen extends AbstractContainerScreen<SeaGUIMenu> {
	private final static HashMap<String, Object> guistate = SeaGUIMenu.guistate;
	...
	public SeaGUIScreen(SeaGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("critterpedia:textures/screens/sea_creature_icon_clicked.png"));
	...
	public void init() {
		...
		imagebutton_fishiconunclicked = new ImageButton(this.leftPos + -40, this.topPos + 23, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_fishiconunclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new SeaGUIButtonMessage(0, x, y, z));
				SeaGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_bird_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 44, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_bird_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new SeaGUIButtonMessage(1, x, y, z));
				SeaGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_bug_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 65, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_bug_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new SeaGUIButtonMessage(2, x, y, z));
				SeaGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_mammal_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 107, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_mammal_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new SeaGUIButtonMessage(3, x, y, z));
				SeaGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_reptileamphibian_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 2, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_reptileamphibian_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new SeaGUIButtonMessage(4, x, y, z));
				SeaGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
