...
import net.derex.critterpedia.network.BirdGUIButtonMessage;
...
public class BirdGUIScreen extends AbstractContainerScreen<BirdGUIMenu> {
	private final static HashMap<String, Object> guistate = BirdGUIMenu.guistate;
	...
	public BirdGUIScreen(BirdGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("critterpedia:textures/screens/bird_icon_clicked.png"));
	...
	public void init() {
		...
		imagebutton_reptileamphibian_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 2, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_reptileamphibian_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new BirdGUIButtonMessage(0, x, y, z));
				BirdGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_fishiconunclicked = new ImageButton(this.leftPos + -40, this.topPos + 23, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_fishiconunclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new BirdGUIButtonMessage(1, x, y, z));
				BirdGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_bug_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 65, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_bug_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new BirdGUIButtonMessage(2, x, y, z));
				BirdGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_sea_creature_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 86, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_sea_creature_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new BirdGUIButtonMessage(3, x, y, z));
				BirdGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_mammal_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 107, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_mammal_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new BirdGUIButtonMessage(4, x, y, z));
				BirdGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
