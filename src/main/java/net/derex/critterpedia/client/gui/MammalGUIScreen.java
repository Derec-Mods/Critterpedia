...
import net.derex.critterpedia.network.MammalGUIButtonMessage;
...
public class MammalGUIScreen extends AbstractContainerScreen<MammalGUIMenu> {
	private final static HashMap<String, Object> guistate = MammalGUIMenu.guistate;
	...
	public MammalGUIScreen(MammalGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("critterpedia:textures/screens/mammal_icon_clicked.png"));
	...
	public void init() {
		...
		imagebutton_fishiconunclicked = new ImageButton(this.leftPos + -40, this.topPos + 23, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_fishiconunclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new MammalGUIButtonMessage(0, x, y, z));
				MammalGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_bird_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 44, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_bird_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new MammalGUIButtonMessage(1, x, y, z));
				MammalGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_bug_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 65, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_bug_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new MammalGUIButtonMessage(2, x, y, z));
				MammalGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_sea_creature_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 86, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_sea_creature_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new MammalGUIButtonMessage(3, x, y, z));
				MammalGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_reptileamphibian_icon_unclicked = new ImageButton(this.leftPos + -40, this.topPos + 2, 20, 20, 0, 0, 20, new ResourceLocation("critterpedia:textures/screens/atlas/imagebutton_reptileamphibian_icon_unclicked.png"), 20, 40, e -> {
			if (true) {
				CritterpediaMod.PACKET_HANDLER.sendToServer(new MammalGUIButtonMessage(4, x, y, z));
				MammalGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
